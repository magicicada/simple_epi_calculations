...
central_file = 'react_based_estimate_number_incoming_infected_from_regions_age_adjusted_using_estimate.csv'
lower_file = 'react_based_estimate_number_incoming_infected_from_regions_age_adjusted_using_lower.csv'
upper_file = 'react_based_estimate_number_incoming_infected_from_regions_age_adjusted_using_upper.csv'
...
central.to_csv('react_based_estimate_number_incoming_infected_from_regions_age_adjusted_combined.csv')
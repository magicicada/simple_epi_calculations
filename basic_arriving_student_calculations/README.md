...
- results using the lower confidence limit are in [estimate_number_incoming_infected_from_regions_using_lower.csv] (estimate_number_incoming_infected_from_regions_using_lower.csv)
